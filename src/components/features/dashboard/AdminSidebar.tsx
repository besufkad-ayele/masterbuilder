        ...
        <div className={cn(
          ...
          <Link href="/admin?tab=dashboard" className="flex items-center gap-3">
            ...
            <div className={cn(
              ...
              <p className="text-lg font-semibold text-foreground whitespace-nowrap">Admin Console</p>
              <p className="text-xs text-muted-foreground whitespace-nowrap">{currentUser?.title || "Leadership Development"}</p>
            </div>
          </Link>
        </div>
