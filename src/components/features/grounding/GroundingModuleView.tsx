...
export const GroundingModuleView: React.FC<GroundingModuleViewProps> = ({
    ...
    const [contentTab, setContentTab] = useState<"videos" | "articles">("videos");
    ...
    const isAllContentRead = useMemo(() => {
        return partOne.sub_factors.every((sf, idx) => {
            ...
            return vUrls.every((u) => completedItems.has(u)) && aUrls.every((u) => completedItems.has(u)) && qPassed;
        });
    ...
    const videoCount = (currentSubFactor.video_urls || []).filter((u) => u && u.trim() !== "").length;
    const articleCount = (currentSubFactor.articles || []).filter((a) => a.link && a.link.trim() !== "").length;
    ...
    const progressPercent = Math.round((completedSubFactors / totalSubFactors) * 100);
                    ...
                    <div className="py-8 sm:py-12 lg:py-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        <div className="text-center mb-10 sm:mb-14 lg:mb-16">
                            ...
                            <p className="text-sm sm:text-base text-[#1B4332]/50 max-w-lg mx-auto">
                                Complete both sections to earn your Grounding certification and build a strong strategic foundation.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-4xl mx-auto">
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="space-y-2 mb-6">
                                        ...
                                        <h3 className="text-xl sm:text-2xl font-bold text-[#1B4332]">{partOne.name}</h3>
                                        <p className="text-sm text-[#1B4332]/50 leading-relaxed">
                                            Master external strategic drivers and global trends shaping your organization.
                                        </p>
                                    </div>
                                    <div className="flex items-center justify-between pt-4 border-t border-[#E8E4D8]">
                                        <div className="flex items-center gap-2">
                                            <div className="w-16 h-1.5 bg-[#E8E4D8] rounded-full overflow-hidden">
                                                <div className="h-full bg-[#1B4332] rounded-full transition-all" style={{ width: `${progressPercent}%` }} />
                                            </div>
                            ...
                            <div className="relative bg-white/60 rounded-2xl sm:rounded-3xl border border-[#E8E4D8] border-dashed p-6 sm:p-8 overflow-hidden select-none">
                                <div className="absolute inset-0 bg-white/40 backdrop-blur-[1px] z-10 flex flex-col items-center justify-center">
                                    ...
                                    <p className="text-sm font-semibold text-[#1B4332]/40">Complete Part I to Unlock</p>
                                    <p className="text-[11px] text-[#1B4332]/25 mt-1">Pass all units and the final assessment</p>
                                </div>
                                <div className="opacity-30">
                                    <div className="flex items-center justify-between mb-6">
                                        ...
                                        <Badge variant="outline" className="text-[10px] font-semibold border-[#1B4332]/10 text-[#1B4332]/30">Locked</Badge>
                                    </div>
                                    <div className="space-y-2 mb-6">
                                        <p className="text-[10px] font-bold uppercase tracking-widest text-[#1B4332]/30">Part II</p>
                                        <h3 className="text-xl sm:text-2xl font-bold text-[#1B4332]/40">{partTwo.name}</h3>
                                        <p className="text-sm text-[#1B4332]/20 leading-relaxed">Internal organizational protocols, values, and frameworks.</p>
                                    </div>
                                    <div className="flex items-center justify-between pt-4 border-t border-[#E8E4D8]/50">
                                        <span className="text-[10px] text-[#1B4332]/20 font-medium">Not started</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-5 bg-[#1B4332] rounded-xl sm:rounded-2xl text-white">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-xs sm:text-sm leading-relaxed">
                                        Complete Part I <span className="text-[#C5A059] font-semibold">Strategic Context</span> first. Part II will unlock after passing the final assessment.
                                    </p>
                                </div>
                                <div className="hidden sm:block text-right shrink-0 pl-4 border-l border-white/10">
                                    <p className="text-[10px] font-bold uppercase tracking-wider text-[#C5A059]">Est. Time</p>
                                        ...
                                        <div className="pt-4">
                                            {isSavingScore ? (
                                                <div className="flex flex-col items-center py-10 space-y-3">
                                                    ...
                                                    <p className="text-xs font-semibold text-[#C5A059]">Recording Achievement...</p>
                                                </div>
                                            ) : (
                                                <QuizModule
                            ...
                            <div className="flex gap-6 lg:gap-8 items-start relative">
                                ...
                                {sidebarOpen && (
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-6">
                                                <h3 className="text-sm font-bold text-[#1B4332]">Learning Units</h3>
                                                <button
                                                    onClick={() => setSidebarOpen(false)}
                                            ...
                                            <div className="p-5 sm:p-8">
                                                <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#E8E4D8]">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <p className="text-[10px] font-bold uppercase tracking-wider text-[#C5A059]">Unit Quiz</p>
                                                            <h3 className="text-base sm:text-lg font-bold text-[#1B4332]">{currentSubFactor.name}</h3>
                                                        </div>
                                                    </div>
                                                    <button
                                                ...
                                                <QuizModule
                                                    ...
                                                    onPass={async (score) => {
                                                        ...
                                                        const percentageScore = currentSubFactor.quiz
                                                            ? Math.round((score / currentSubFactor.quiz.length) * 100)
                                                            : 100;
                                                ...
                                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-[#C5A059]/10 flex items-center justify-center border border-[#C5A059]/20 shrink-0">
                                                            <span className="text-sm font-bold text-[#C5A059]">
                                                                {String(activeSubFactorIdx + 1).padStart(2, "0")}
                                                            </span>
                                                        </div>
                                                        <div>
                                                            <p className="text-[10px] font-bold uppercase tracking-wider text-[#C5A059]">
                                                                Unit {activeSubFactorIdx + 1} of {totalSubFactors}
                                                            </p>
                                                    ...
                                                    {isUnitQuizPassed && (
                                                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-50 border border-green-200">
                                                            ...
                                                            <span className="text-[11px] font-semibold text-green-700">Completed</span>
                                                        </div>
                                                    )}
                                                </div>
                                                <p className="text-sm text-[#1B4332]/50 mt-3 leading-relaxed max-w-2xl">
                                                    Explore the fundamental principles of {currentSubFactor.name} through video lectures and curated articles. Complete all materials and pass the quiz to continue.
                                                </p>
                                            </div>
                                                ...
                                                <div className="flex border-b border-[#E8E4D8]">
                                                    <button
                                                        ...
                                                        className={cn(
                                                            ...
                                                            contentTab === "videos" ? "text-[#1B4332]" : "text-[#1B4332]/35 hover:text-[#1B4332]/60"
                                                        )}
                                                    >
                                                        ...
                                                        {videoCount > 0 && (
                                                            <span className={cn(
                                                                ...
                                                                contentTab === "videos" ? "bg-[#1B4332] text-white" : "bg-[#E8E4D8] text-[#1B4332]/40"
                                                            )}>
                                                                {videoCount}
                                                            </span>
                                                        )}
                                                    ...
                                                    <button
                                                        ...
                                                        className={cn(
                                                            "flex-1 flex items-center justify-center gap-2 py-3.5 sm:py-4 text-xs sm:text-sm font-semibold transition-all relative",
                                                            contentTab === "articles" ? "text-[#1B4332]" : "text-[#1B4332]/35 hover:text-[#1B4332]/60"
                                                        )}
                                                    >
                                                        ...
                                                        {articleCount > 0 && (
                                                            <span className={cn(
                                                                "w-5 h-5 rounded-full text-[10px] font-bold flex items-center justify-center",
                                                                contentTab === "articles" ? "bg-[#1B4332] text-white" : "bg-[#E8E4D8] text-[#1B4332]/40"
                                                            )}>
                                                                {articleCount}
                                                            </span>
                                                        )}
                                                ...
                                                <div className="p-4 sm:p-6 lg:p-8">
                                                    {contentTab === "videos" ? (
                                                        <div className="space-y-5 animate-in fade-in duration-300">
                                                            ...
                                                            currentSubFactor.video_urls.filter((u) => u && u.trim() !== "").length > 0 ? (
                                                                <div className="flex flex-col gap-5">
                                                                    {currentSubFactor.video_urls
                                                                        .filter((u) => u && u.trim() !== "")
                                                                        .map((url, vIdx) => (
                                                                            <div key={vIdx} className="relative">
                                                                                <div className="aspect-video bg-[#0a0a0a] rounded-xl sm:rounded-2xl overflow-hidden relative group shadow-lg border border-[#E8E4D8] w-full">
                                                                                    <iframe
                                                                                    ...
                                                                                    {completedItems.has(url) && (
                                                                                        <div className="absolute top-3 right-3 sm:top-4 sm:right-4">
                                                                                            <div className="w-7 h-7 rounded-full bg-green-500 flex items-center justify-center shadow-lg ring-2 ring-white/20">
                                                                ...
                                                                <div className="aspect-video bg-[#F5F3EE] rounded-xl sm:rounded-2xl flex flex-col items-center justify-center border border-dashed border-[#E8E4D8]">
                                                                    ...
                                                                    <p className="text-sm text-[#1B4332]/30 font-medium">Video content coming soon</p>
                                                                </div>
                                                            )}
                                                        </div>
                                                    ) : (
                                                        <div className="space-y-4 animate-in fade-in duration-300">
                                                            ...
                                                            currentSubFactor.articles.filter((a) => a.link && a.link.trim() !== "").length > 0 ? (
                                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                                    {currentSubFactor.articles
                                                                        .filter((a) => a.link && a.link.trim() !== "")
                                                                        .map((art, artIdx) => (
                                                                            <a
                                                                                key={artIdx}
                                                                                href={art.link}
                                                                                ...
                                                                                <div className="aspect-[16/10] relative overflow-hidden bg-[#E8E4D8]/30">
                                                                                    ...
                                                                                    <div className="absolute top-2 left-2 sm:top-3 sm:left-3">
                                                                                        <Badge className="bg-[#C5A059] text-[#1B4332] border-0 text-[9px] font-bold uppercase tracking-wider">
                                                                                            {artIdx === 0 ? "Primary" : "Reference"}
                                                                                        </Badge>
                                                                                    </div>
                                                                                    {completedItems.has(art.link) && (
                                                                ...
                                                                <div className="py-12 flex flex-col items-center justify-center border border-dashed border-[#E8E4D8] rounded-xl sm:rounded-2xl bg-[#F5F3EE]">
                                                                    ...
                                                                    <p className="text-sm text-[#1B4332]/30 font-medium">No articles for this unit</p>
                                                                </div>
                                                            )}
                                                        </div>
                                                    )}
                                                        ...
                                                        {currentSubFactor.quiz &&
                                                            ...
                                                            (isUnitQuizPassed ? (
                                                                <div className="flex items-center gap-2 px-4 py-2.5 bg-green-50 border border-green-200 rounded-xl">
                                                                    ...
                                                                    <div>
                                                                        <p className="text-[10px] font-bold text-green-700 uppercase tracking-wider">Passed</p>
                                                                        <p className="text-xs font-semibold text-green-600">
                                                                            {groundingScores[moduleData.id]?.[`quiz_passed_subfactor_${activeSubFactorIdx}`] ?? "100"}%
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            ) : (
            ...
            <div className="space-y-2">
                {!isMobile && (
                    <div className="pl-3 border-l-[3px] border-[#C5A059] mb-5">
                        <p className="text-[10px] font-bold uppercase tracking-wider text-[#C5A059]">Learning Path</p>
                        <h3 className="text-base font-bold text-[#1B4332] mt-0.5">{partOne.name}</h3>
                    </div>
                )}
                ...
                <div className="space-y-1.5">
                    {partOne.sub_factors.map((factor, idx) => {
                        ...
                        const isDone = completedItems.has(`quiz_passed_subfactor_${idx}`);
                                ...
                                <div className="min-w-0 flex-1">
                                    <p
                                        className={cn(
                                            ...
                                            isActive ? "text-white" : isDone ? "text-[#1B4332]/70" : isUnlocked ? "text-[#1B4332]/60" : "text-[#1B4332]/25"
                                        )}
                                    >
                                        {factor.name}
                                    </p>
                                    {!isUnlocked && (
                                        <p className="text-[9px] text-red-400/60 font-medium mt-0.5">Locked</p>
                                    )}
                                </div>

                                {isActive && <ChevronRight className="w-3.5 h-3.5 text-[#C5A059] shrink-0" />}
                            </button>
                        );
                    })}
                </div>
